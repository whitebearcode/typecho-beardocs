...
<font style="font-size:15px">
        我们制作了一个使用本主题的<a href="https://www.bearnotion.ru/userWebsites.html?type=beardocs">[站点展示列表页]</a>，若想将您的站点展示出来，请点击下方按钮申请加入，若已经加入将显示 [已加入] 标识和站点密钥SiteKey，该密钥后面将作为凭证用于修改展示的站点信息，我们也会定期检查站点，未达到条件者将被终止展示资格。</font><br>
